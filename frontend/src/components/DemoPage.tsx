...
export function DemoPage() {
  ...
  useEffect(() => {
    ...
    // codeql[js/externally-controlled-format-string] Safe internal debug log
    // theme is from controlled state, not user input
  ...
  // Demo state
  const demoWorkingDirectory = "/Users/demo/qwen-code-webui";
